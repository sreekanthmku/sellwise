...
export default function ActiveCall() {
  ...
  const keypadDestination =
    typeof location.state?.dialDestination === "string"
      ? location.state.dialDestination.trim()
      : "";
  ...
  useEffect(() => {
    ...
    const override = keypadDestination || null;
    const rawPhone = override ?? detailRow.phoneDisplay;
    const result = placeOutboundCall({
      destination: sanitizeDialString(rawPhone),
      name: lead.name,
      subtitle: rawPhone || "",
      avatar: null,
      leadId,
  ...
  }, [lead, leadId, registered, placeOutboundCall, keypadDestination]);
